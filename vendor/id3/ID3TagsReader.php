<?php
# Very lightly modified from http://www.script-tutorials.com/id3-tags-reader-with-php/

class ID3TagsReader {

    private $aTV23 = array( // array of possible sys tags (for last version of ID3)
        'TIT2',
        'TALB',
        'TPE1',
        'TPE2',
    ...
    private $aTV23t = array( // array of titles for sys tags
        'Title',
        'Album',
        'Author',
        'AlbumAuthor',
    ...
    private $aTV22 = array( // array of possible sys tags (for old version of ID3)
        'TT2',
        'TAL',
        'TP1',
        'TRK',
    ...
    private $aTV22t = array( // array of titles for sys tags
        'Title',
        'Album',
        'Author',
        'Track',
    ...
    public function getTagsInfo($sFilepath) {
        ...
        if (isset($aInfo['Version']) && ($aInfo['Version'] == '4.0' || $aInfo['Version'] == '3.0')) {
        ...
        }else if(isset($aInfo['Version']) && $aInfo['Version'] == '2.0') {
